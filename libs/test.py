import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QVBoxLayout, QLabel, QPushButton, QWidget, QDesktopWidget, QHBoxLayout, QScrollArea, QMenu, QAction, QInputDialog, QDialog, QLineEdit,QSizePolicy,QTextEdit
from PyQt5.QtCore import Qt
from PyQt5.QtGui import QPixmap, QIcon
# from rename_dialog import RenameDialo
...
class MainWindow(QMainWindow):
    ...
    def create_left_section(self):
        ...
        history_files = [f"File{i}.txt" for i in range(1, 10)]  # 25 files for scrollability
